...
#SBATCH --output ../tucker_att_ic14.out
#SBATCH --error ../tucker_att_ic14.err

# CUDA_VISIBLE_DEVICES=0 python -u learn.py --dataset YAGO15K --model TuckER_ATT --rank1 400 --rank2 400 --optimizer Adagrad \
# --learning_rate 1e-1 --batch_size 128 --regularizer N3 --reg 1e-2 --reg_t 1e-1 --p 4 --max_epochs 50 \
# --valid 5 -train -id 0 -save --ratio 1.0 --dropout 0.1 --no_time_emb --init 0.01

CUDA_VISIBLE_DEVICES=1 python -u learn.py --dataset ICEWS14 --model TuckER_ATT --rank1 400 --rank2 400 --optimizer Adagrad \
--learning_rate 1e-1 --batch_size 128 --regularizer N3 --reg 1e-2 --reg_t 0.5 --p 4 --max_epochs 50 \
--valid 5 -train -id 0 -save -weight --ratio 0.9 --dropout 0.1 --init 0.001
