...
#SBATCH --output ../tucker_dft_debug_ic14.out
#SBATCH --error ../tucker_dft_debug_ic14.err

# CUDA_VISIBLE_DEVICES=3 python -u learn.py --dataset YAGO15K --model TuckER_DFT --rank1 200 --rank2 200 --optimizer Adagrad \
# --learning_rate 1e-1 --batch_size 128 --regularizer L4 --reg 1e-2 --reg_t 1e-1 --p 4 --max_epochs 50 \
# --valid 5 -train -id 0 -save --ratio 0.8 --dropout 0.0 --no_time_emb

CUDA_VISIBLE_DEVICES=0 python -u learn.py --dataset ICEWS14 --model TuckER_DFT --rank1 200 --rank2 200 --optimizer Adagrad \
--learning_rate 1e-1 --batch_size 128 --regularizer L4 --reg 1e-2 --reg_t 1e-1 --p 4 --max_epochs 50 \
--valid 5 -train -id 0 -save --ratio 0.8 --dropout 0.1
