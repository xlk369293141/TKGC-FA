...
#SBATCH --output ../tucker_dft_dura_ic14.out
#SBATCH --error ../tucker_dft_dura_ic14.err

CUDA_VISIBLE_DEVICES=3 python -u learn.py --dataset ICEWS14 --model TuckER_DFT --rank1 200 --rank2 200 --optimizer Adagrad \
--learning_rate 1e-1 --batch_size 256 --regularizer DURA --reg 1e-2 --max_epochs 100 \
--valid 10 -train -id 1 -save -weight --ratio 0.64
